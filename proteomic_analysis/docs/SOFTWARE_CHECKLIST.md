...
| Dependencies and versions | `proteomic_analysis/README.md`; exact local versions can be captured with `sessionInfo()` |
| Tested OS and R versions | `proteomic_analysis/README.md`; CI workflow under `.github/workflows/proteomic-analysis-demo.yml` |
